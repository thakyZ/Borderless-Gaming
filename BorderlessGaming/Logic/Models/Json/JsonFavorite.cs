...
{
    public partial class JsonFavorite
    {
        /// <summary>
        ...
        public static JsonFavorite FromWindow(ProcessDetails pd)
        {
            return new JsonFavorite { SearchText = pd.BinaryName, Screen = JsonProcessRectangle.Empty};
        }
